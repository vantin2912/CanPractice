...
/* Definitions for CANRcv */
osThreadId_t CANRcvHandle;
const osThreadAttr_t CANRcv_attributes = {
  .name = "CANRcv",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for CANTransmit_Timer */
osTimerId_t CANTransmit_TimerHandle;
const osTimerAttr_t CANTransmit_Timer_attributes = {
  .name = "CANTransmit_Timer"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_CANRcv_Task */
/**
  * @brief  Function implementing the CANRcv thread.
